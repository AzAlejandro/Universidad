...
ggplot(tabla_filtrocol4, aes(x = reorder(farmacia, mean_degree), y = mean_degree)) +
  geom_col(width = 0.7,position=position_dodge(0.5), fill = "steelblue") +
  theme_minimal()+
  geom_text(aes(label=round(mean_degree,2)), vjust=0.4,hjust = 1.3, size=3.5, color = "white")+
